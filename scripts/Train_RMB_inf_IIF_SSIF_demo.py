...
np.save(exp_dir+'epoch_loss_train_arr',epoch_loss_train_arr)
np.save(exp_dir+'epoch_loss_valid_arr',epoch_loss_valid_arr)
np.save(exp_dir+'epoch_loss_test_arr',epoch_loss_test_arr)
