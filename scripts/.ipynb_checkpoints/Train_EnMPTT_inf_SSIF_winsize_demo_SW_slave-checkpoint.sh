...
#SBATCH -p v100
#SBATCH --gres=gpu:1
#SBATCH --output=Train_EnMPTT_eraser_1_inf_SSIF_winsize.txt

conda activate pytorch_a100

# This is the shell script to run the experiment.
run_task=Train_EnMPTT_eraser_1_inf_SSIF_SW_v2
...
# This is the shell script to run the experiment.
run_task=Train_EnMPTT_eraser_1_inf_SSIF_SNO_v2
output_vars=SNOmm
rversion=hs32
hidden_size=32
epochs=500
...
# This is the shell script to run the experiment.
run_task=Train_EnMPTT_eraser_1_inf_SSIF_SF_v2
